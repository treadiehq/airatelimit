    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-15">
        ...
        <nav class="items-center space-x-4 hidden lg:flex lg:flex-1 lg:justify-end">
          ...
          <!-- Show Dashboard if logged in, Sign In if not -->
          <NuxtLink v-if="isAuthenticated" to="/projects" class="text-sm border font-medium flex items-center gap-2 rounded-lg bg-gray-500/10 border-gray-500/10 text-white hover:bg-gray-500/20 transition-colors py-1.5! px-4!">
            <span>Dashboard</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4">
              <path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM6.75 9.25a.75.75 0 0 0 0 1.5h4.59l-2.1 1.95a.75.75 0 0 0 1.02 1.1l3.5-3.25a.75.75 0 0 0 0-1.1l-3.5-3.25a.75.75 0 1 0-1.02 1.1l2.1 1.95H6.75Z" clip-rule="evenodd" />
            </svg>
          </NuxtLink>
          <NuxtLink v-else to="/login" class="text-sm border font-medium flex items-center gap-2 rounded-lg bg-gray-500/10 border-gray-500/10 text-white hover:bg-gray-500/20 transition-colors py-1.5! px-4!">
            <span>Sign In</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4">
              <path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM6.75 9.25a.75.75 0 0 0 0 1.5h4.59l-2.1 1.95a.75.75 0 0 0 1.02 1.1l3.5-3.25a.75.75 0 0 0 0-1.1l-3.5-3.25a.75.75 0 1 0-1.02 1.1l2.1 1.95H6.75Z" clip-rule="evenodd" />
            </svg>
						...
						<div class="mt-6 flow-root">
							<div class="-my-6 divide-y divide-gray-500/15">
								...
								<div class="py-6 flex flex-col gap-2">
									...
									<NuxtLink v-if="isAuthenticated" to="/projects" class="-mx-3 flex border border-gray-500/10 bg-gray-500/10 items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold text-white hover:bg-gray-500/20">
										Dashboard
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4">
											<path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM6.75 9.25a.75.75 0 0 0 0 1.5h4.59l-2.1 1.95a.75.75 0 0 0 1.02 1.1l3.5-3.25a.75.75 0 0 0 0-1.1l-3.5-3.25a.75.75 0 1 0-1.02 1.1l2.1 1.95H6.75Z" clip-rule="evenodd" />
										</svg>
									</NuxtLink>
									<NuxtLink v-else to="/login" class="-mx-3 flex border border-gray-500/10 bg-gray-500/10 items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold text-white hover:bg-gray-500/20">
										Log in
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4">
											<path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16ZM6.75 9.25a.75.75 0 0 0 0 1.5h4.59l-2.1 1.95a.75.75 0 0 0 1.02 1.1l3.5-3.25a.75.75 0 0 0 0-1.1l-3.5-3.25a.75.75 0 1 0-1.02 1.1l2.1 1.95H6.75Z" clip-rule="evenodd" />
										</svg>
