      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-15">
          ...
          <nav class="flex items-center space-x-4">
            ...
            <NuxtLink to="/login" class="text-sm border font-medium flex items-center gap-2 border-transparent rounded-lg bg-white text-black hover:bg-white/90 transition-colors py-1.5! px-3!">
              <span>Sign In</span>
