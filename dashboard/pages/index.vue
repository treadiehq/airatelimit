      ...
      <div class="text-center">
        ...
        <div class="mb-14">
          ...
          <div class="flex items-center justify-center gap-2">
            <NuxtLink to="/login" class="text-sm border justify-center w-44 font-medium flex items-center gap-2 rounded-lg bg-blue-300 border-blue-300 text-black hover:bg-blue-200 transition-colors py-2 px-4!">
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div class="bg-gray-500/5 border border-gray-500/10 rounded-xl p-6 flex flex-col">
            ...
            <a href="mailto:info@airatelimit.com" class="block w-full text-center py-2 px-4 rounded-lg border border-gray-500/10 text-white hover:bg-gray-500/10 transition-colors text-sm font-medium mt-auto">
              Contact Sales
            </a>
          </div>
        </div>
