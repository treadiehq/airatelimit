...
// Shields.io badge image URL (simple version without base64 logo - works everywhere)
const badgeImageUrl = computed(() => {
  return `https://img.shields.io/badge/AI_Ratelimit-Sponsor_me-black?style=for-the-badge`
})
